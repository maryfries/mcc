...
<?php include 'includes/navigation.inc'; ?>
            ...
            <div id="maincontent">
                ...
                <h4><span class="bold"><a href="research/curriculum.php">The Mathematics &nbsp;Instructional Materials Study at EDC</a></span></h4>
                <p>EDC was recently funded by the NSF to engage in a mixed-methods study of 10&ndash;12 school districts&rsquo; implementation of elementary mathematics instructional materials. This research project builds on earlier work and will look specifically at the relationships between district and school level support for implementation and the effects on use and student outcomes. <a href="research/curriculum.php">Learn more about this implementation project.</a></p>

                <h4><span class="bold"><a href="research/use.php">Effective Use of Mathematics Instructional Materials</a></span></h4>
                <p>Nearing completion, this applied research study sought to investigate mathematics textbook selection, with particular attention to the decisions curriculum leaders make as they navigate the selection process and the key factors affecting these decisions. Given this era of accountability it is not surprising that state standards and tests were highly influential in crafting an initial set of materials for consideration. Additionally, we found that the context in which decisions are made is also critical. However, there are many openings in the process for curriculum leaders to influence the process.<a href="research/use.php"> Learn more about this textbook selection project.</a></p>
            </div> 
